...
$temperature = $mqtt->subscribeAndWaitForMessage('G231220049/temperature', 0);
$humidity = $mqtt->subscribeAndWaitForMessage('G231220049/humidity', 0);
$control = $mqtt->subscribeAndWaitForMessage('G231220049/control', 0);
