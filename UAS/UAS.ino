...
// Konfigurasi WiFi
const char* wifi_ssid = "Agry Dapoer Omahan";
const char* wifi_password = "agryshevaizzandiaz";

// Konfigurasi MQTT
const char* mqtt_server = "x2.revolusi-it.com"; 
const char* mqtt_username = "usm";
const char* mqtt_password = "usmjaya001";
const char* client_id = "G231220049_NodeMCU";
...
void reconnect() {  
  while (!client.connected()) {  
    ...
    if (client.connect(client_id, mqtt_username, mqtt_password)) {  
      ...
      client.subscribe("G231220049/control");
    } else {  
...
void publishTempAndHumid(){
  client.publish("G231220049/temperature", String(temperature).c_str(), true);
  client.publish("G231220049/humidity", String(humidity).c_str(), true);
}
